...
extension Data {
    ...
    func convertDataToHexString() -> [String] {
        let byteBuffer = [UInt8](self)
        var s = [String](repeating: "", count: byteBuffer.count)
  ...
  func toInt32(byteOrder : ByteOrder) -> Int32 {
         
         let value : Int32! = self.withUnsafeBytes { (ptr: UnsafePointer<Int32>) -> Int32 in
             return ptr.pointee
         }
    ...
    func toFloat32(byteOrder : ByteOrder) -> Float32 {
